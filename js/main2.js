...
function initSkel() {
    ...
    /*if (!Modernizr.touch && getWindowWidth() > 991 && Modernizr.csstransforms3d) {
        ...
        window.setTimeout(function () {
            ...
            if ($body.hasClass('animate')) {
                setTimeout(function () {
                    ...
                    console.log('more loading animation can be added here');
                    //disable svg animation
                    /*
                    setTimeout(function() {
                        $('.landing-holder').addClass('svg-animated');
                        var paths = $('.landing-holder .svg-animation path:not(defs path), .landing-holder .svg-animation polygon:not(defs polygon)');
                        var tl = new TimelineMax();

                        paths.each(function(i, e) {
                            e.style.strokeDasharray = e.style.strokeDashoffset = e.getTotalLength();
                            tl.add([
                                TweenLite.to(paths.eq(i), e.getTotalLength()/1000, {strokeDashoffset: 0, stroke:"#ffffff", delay:i*.0001 })
                            ]);
...
*/
    ...
    $window.resize(function () {
        if (skel.vars.mobile || getWindowWidth() < 992) {
            ...
            $('[data-scroll-speed]').css('transform', 'translateX(0)');
    ...
    $body.on('click', '.btn.btn-menu', function (e) {
        //console.log(settings.scrollWheel.enabled);
        if (getWindowWidth() > 991) {
